...
class Moment extends Publisher
{
  /**
   ...
   * @var string
   */
  protected $source = ROOTPATH . 'node_modules/moment/';
   ...
   * @var string
   */
  protected $destination = FCPATH . 'assets' . DIRECTORY_SEPARATOR . 'moment' . DIRECTORY_SEPARATOR . 'dist';
