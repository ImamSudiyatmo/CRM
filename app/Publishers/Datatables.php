...
class Datatables extends Publisher
{
  /**
   ...
   * @var string
   */
  protected $source = ROOTPATH . 'node_modules/datatables.net/';
   ...
   * @var string
   */
  protected $destination = FCPATH . 'assets' . DIRECTORY_SEPARATOR . 'datatables' . DIRECTORY_SEPARATOR . 'dist';
